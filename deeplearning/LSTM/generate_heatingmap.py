    ...
    for subclass in ['test', 'train', 'val']:
        ...
        for type in [3, 2, 0, 1]:
            features, labels = generate_heatingmaps(
                '/home/give/Documents/dataset/MICCAI2018/Slices/crossvalidation/' + str(crossid) + '/' + subclass,
                type,
                8,
                os.path.join(
                    '/home/give/Documents/dataset/MICCAI2018/Heatingmap/LSTM/crossvalidation/' + str(crossid),
                    subclass
                )
            )
        ...
        scio.savemat('./features/crossvalidation/' + str(crossid) + '/' +subclass+'.npy', {
