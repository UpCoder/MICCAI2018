    ...
    # for subclass in ['0', '1', '2']:
        for typeid in ['0', '1', '2', '3', '4']:
            ExtractPatch.extract_patch_npy(
                '/home/give/Documents/dataset/MICCAI2018/Slices/crossvalidation/1/'+subclass,
                typeid,
                '/home/give/Documents/dataset/MICCAI2018/Patches/crossvalidation/1/' + subclass + '/' + typeid,
                patch_size=8
            )
