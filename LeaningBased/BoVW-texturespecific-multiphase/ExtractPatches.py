...
def read_from_dir_multiphase(data_dir):
    mhd_images = []
    mask_images = []
    for phasename in ['NC', 'ART', 'PV']:
        mask_image, mhd_image = read_from_dir(data_dir, phasename)
        mhd_images.append(mhd_image)
        mask_images.append(mask_image)
    return convert2depthlaster(mask_images), convert2depthlaster(mhd_images)
...
def extract_patches_multidir(data_dir, subclasses=['train', 'val', 'test'], target_labels=[0, 1, 2, 3],
                             ...
                             save_dir='/home/give/Documents/dataset/ICPR2018/BoVW-TextSpecific-multiphase', return_flag=False):
    patches = []
    labeles = []
    coding_labeles = []
...
if __name__ == '__main__':
    extract_patches_multidir('/home/give/Documents/dataset/MICCAI2018/Slices/un-crossvalidation',
                             save_dir='/home/give/Documents/dataset/MICCAI2018/Patches/LearningBased/BoVW-TextureSpecific-multiphase')