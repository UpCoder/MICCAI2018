...
def generate_representor_multidir(interior_path, boundary_path, patch_dir, reload=None, save_dir=None):
    if reload is None:
...
if __name__ == '__main__':
    ...
    crossid = 0
    acc = generate_representor_multidir(
        interior_path='/home/give/PycharmProjects/MICCAI2018/LeaningBased/BoVW-DualDict-New/vocabulary/' + str(
            crossid) + '/vocabulary_interior.model',
        boundary_path='/home/give/PycharmProjects/MICCAI2018/LeaningBased/BoVW-DualDict-New/vocabulary/' + str(
            crossid) + '/vocabulary_boundary.model',
        patch_dir='/home/give/Documents/dataset/MICCAI2018/Slices/crossvalidation/' + str(crossid),
        save_dir='/home/give/PycharmProjects/MICCAI2018/LeaningBased/BoVW-DualDict-New/mat/' + str(crossid),
        reload=None,
    )