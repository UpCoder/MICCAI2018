...
if __name__ == "__main__":
    crossid = 1
    generate_dictionary(
        data_dir='/home/give/Documents/dataset/MICCAI2018/Patches/LearningBased/BoVW-DualDict/boundary_data.mat',
        save_path='./vocabulary/' + str(crossid) + '/vocabulary_boundary.model', vocabulary_size=128)
    generate_dictionary(
        data_dir='/home/give/Documents/dataset/MICCAI2018/Patches/LearningBased/BoVW-DualDict/interior_data.mat',
        save_path='./vocabulary/' + str(crossid) + '/vocabulary_interior.model', vocabulary_size=32)
