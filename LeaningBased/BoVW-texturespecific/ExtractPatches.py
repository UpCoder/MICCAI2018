...
def extract_patches_multidir(data_dir, subclasses=['train', 'val', 'test'], target_labels=[0, 1, 2, 3],
                             ...
                             save_dir='/home/give/Documents/dataset/ICPR2018/BoVW-TextSpecific', return_flag=False):
    patches = []
    labeles = []
    coding_labeles = []
...
if __name__ == '__main__':
    extract_patches_multidir('/home/give/Documents/dataset/MICCAI2018/Slices/crossvalidation/0',
                             save_dir='/home/give/Documents/dataset/MICCAI2018/Patches/LearningBased/BoVW-TextureSpecific')