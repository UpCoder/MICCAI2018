...
def generate_representor_multidir(data_dir, patch_dir, save_dir='./mat/1', reload=None):
    if reload is None:
...
if __name__ == '__main__':
    ...
    acc = generate_representor_multidir(
        patch_dir='/home/give/PycharmProjects/MICCAI2018/LeaningBased/BoVW-CO/vocabulary/' + str(crossid) +'/vocabulary.model',
        data_dir='/home/give/Documents/dataset/MICCAI2018/Slices/crossvalidation/' + str(crossid),
        save_dir='/home/give/PycharmProjects/MICCAI2018/LeaningBased/BoVW-CO/mat/' + str(crossid),
        reload=True,
    )